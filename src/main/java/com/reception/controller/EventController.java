...
public class EventController {
	  ...
	  @PutMapping("/update")//updates works based on argument id. through postman pass the eventid which should 
	                      //be updated.update works as save without passing eventid.
	  @PreAuthorize("hasRole('ROLE_VISITOR')")
		public Events updateUserData(@RequestBody Events event) {
